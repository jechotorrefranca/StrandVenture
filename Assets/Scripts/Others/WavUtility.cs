...
public static class WavUtility
{
    ...
    public static AudioClip ToAudioClip(byte[] wavFile, int offsetSamples = 0, string name = "GroqTTSClip")
    {
        ...
        try
        {
            ...
            using (var reader = new System.IO.BinaryReader(memoryStream))
            {
                ...
                int sampleCount = (wavFile.Length - 44) / 2; // 16-bit samples
        ...
        {
            Debug.LogError("Failed to convert WAV to AudioClip: " + ex.Message);
            return null;
        }
    }
