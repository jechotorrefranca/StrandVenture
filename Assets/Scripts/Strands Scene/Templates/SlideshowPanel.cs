...
/// <summary>
/// Slideshow panel driven by data on InteractableItem.
/// Attach this to your slideshow panel prefab.
/// Make sure the prefab is assigned as interactionPanelPrefab on the InteractableItem.
/// </summary>
public class SlideshowPanel : MonoBehaviour, IInteractableUI
{
    ...
    public void Init(InteractableItem item, InteractionManager manager)
    {
        ...
        {
            Debug.LogWarning($"[SlideshowPanel] Item '{item.name}' has no slideshowImages assigned.");
            return;
        }
